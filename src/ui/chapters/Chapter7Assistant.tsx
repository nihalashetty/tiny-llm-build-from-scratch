...
function PipelineDiagram() {
  const stages = [
    { t: 'Pretrain', s: 'Predict the next token on ~all the web', c: '#e0553a' },
    { t: 'Fine-tune', s: 'Copy examples of instructions being followed', c: '#e0913c' },
    { t: 'RLHF', s: 'Learn what humans rate as “good”', c: '#10866a' },
  ...
  return (
    <ChapterFrame id="assistant">
      <Beat as="p" className="lead">
        ...
        reply with more questions. Turning that mimic into ChatGPT-style help takes
        three more moves on top of the pretraining that created it - four stages in
        all.
      </Beat>
