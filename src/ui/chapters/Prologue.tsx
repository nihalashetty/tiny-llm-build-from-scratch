    ...
    <svg viewBox="0 0 640 220" width="100%" role="img" aria-label="Text goes into a black box and text comes out">
      <defs>
        <marker id="arrow" markerWidth="10" markerHeight="10" refX="7" refY="3" orient="auto">
          <path d="M0,0 L7,3 L0,6 Z" fill="#c0b199" />
        </marker>
      </defs>

      {/* input */}
      <rect x="8" y="86" width="176" height="48" rx="10" fill="#fdf6ec" stroke="#eae0d3" />
      <text x="96" y="115" textAnchor="middle" fontFamily="'JetBrains Mono', monospace" fontSize="14" fill="#4a423b">
        the queen wears a…
      </text>

      <line x1="188" y1="110" x2="236" y2="110" stroke="#c0b199" strokeWidth="2" markerEnd="url(#arrow)" />

      {/* the box */}
      <rect x="240" y="40" width="160" height="140" rx="18" fill="#26211d" />
      <text x="320" y="128" textAnchor="middle" fontFamily="'Bricolage Grotesque', sans-serif" fontSize="72" fontWeight="800" fill="#f0663e">
        ?
      </text>
      <text x="320" y="164" textAnchor="middle" fontFamily="'JetBrains Mono', monospace" fontSize="11" fill="#8e8577">
        the model
      </text>

      <line x1="404" y1="110" x2="452" y2="110" stroke="#c0b199" strokeWidth="2" markerEnd="url(#arrow)" />

      {/* output */}
      <rect x="456" y="86" width="176" height="48" rx="10" fill="#fde7de" stroke="#f6c9b8" />
      <text x="544" y="115" textAnchor="middle" fontFamily="'JetBrains Mono', monospace" fontSize="15" fill="#c24a28">
        gold
      </text>
    </svg>
  );
